            ...
            <Fragment>
                ...
                <form method="post">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="runtime" name="runtime" value={movie.release_date}/>
                    </div>
                    <div className="mb-3">
                        <label for="mpaa-rating" className="form-label">MPAA Rating</label>
                        <select className="form-select" value={movie.mpaa_rating}>
                        <option className="form-select" value="G">Choose...</option>
